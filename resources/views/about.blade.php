...
<section class="breadcrumb pt-150 pb-150 bg_img" data-background="assets/images/bg/breadcrumb-bg-1.jpeg" data-overlay="dark" data-opacity="5">
    <div class="container">
        <div class="row">
            <div class="col-xl-12">
        ...
        <div class="row">
            <div class="col-xl-6 col-lg-6">
                <div class="about__bg about__bg--4">
                    <img src="assets/images/bg/about-bg-3.jpeg" data-tilt data-tilt-perspective="3000" alt="">
                    <img class="f-right" src="assets/images/bg/about-bg-4.jpeg" data-tilt data-tilt-perspective="3000" alt="">
                </div>
            </div>
            <div class="col-xl-6 col-lg-6 pl-20 mt-70">
                ...
                <div class="about__box about__box--2">
                    <p>Neuroon Informatic (Pvt) Ltd is a full-service software development,
                        server hosting and digital marketing agency based in Colombo. Guided
                        by trusted upcoming leadership it spearheads the sustainable researchbased development of the 3D designing, graphic designing, mobile
                        application development, server maintenance, email maintenance and
                        software industry in Sri Lanka.

                        <br />
                        <br />
                        In today’s digital business world, you need a partner who can help you
                        take advantage of marketing opportunities across a variety of channels
                        in real-time. Neuroon Informatic (Pvt) Ltd
                        combine a data-driven
                        approach with knowledge gained from years in software development,
                        server hosting and digital marketing to deliver outstanding results to
                        our clients.

                        <br />
                        <br />
                        And also, we offer, along with information and pricing for a custom
                        digital marketing, server hosting and software system development and
                        maintenance solution based on your needs.
                        <br />
                ...
                <div class="row no-gutters mt-none-30">
                    <div class="col-xl-6 mt-30">
                        <div class="department__box department__box--border pr-50">
                            ...
                            <div class="department__box--content">
                                <h4 class="title mb-15">Mission</h4>
                    ...
                    <div class="col-xl-6 mt-30">
                        <div class="department__box pl-50">
                            ...
                            <div class="department__box--content">
                                <h4 class="title mb-15">Vision</h4>
...
<section class="testimonial__area pt-95 pb-95">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-xl-7 text-center">
                <div class="section__heading mb-50">
...
<!-- timeline area start -->
<section class="timeline-area pt-95 pb-100 bg_img" data-background="assets/images/pattern/timeline-pattern.png">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-xl-7 text-center">
                <div class="section__heading white mb-60">
                    <h4 class="section__heading--title-small"><span class="mr-10">//</span>Our Journey<span class="ml-10">//</span>
                    </h4>
